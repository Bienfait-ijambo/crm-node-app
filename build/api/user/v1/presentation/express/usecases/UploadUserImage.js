...
const UploadUserImage_1 = require("../../../domain-model/usecases/UploadUserImage");
...
class UploadUserPhoto {
    static upload(req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield UploadUserPhoto.saveImg(imgurl, email);
    ...
    static saveImg(imgUrl, email) {
        return __awaiter(this, void 0, void 0, function* () {
            const usecase = new UploadUserImage_1.UploadUserImage(TypeormUserRepo_1.userRepo);
            const input = {
                email: email,
                image: imgUrl
            };
...
], UploadUserPhoto, "saveImg", null);
exports.UploadUserPhoto = UploadUserPhoto;
//# sourceMappingURL=UploadUserImage.js.map