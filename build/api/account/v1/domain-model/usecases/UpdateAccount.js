...
const CreateUpdateAccountInput_1 = require("../dto/CreateUpdateAccountInput");
class UpdateAccountUseCase {
    ...
    execute(input) {
        return __awaiter(this, void 0, void 0, function* () {
            const dto = new CreateUpdateAccountInput_1.CreateUpdateAccountInput(input);
            const result = yield data_source_1.AppDataSource.transaction(() => __awaiter(this, void 0, void 0, function* () {
                const updateAccount = yield this.repo.updateAccount(dto.getInput());
