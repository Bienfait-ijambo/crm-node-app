...
exports.GetServiceUserCase = void 0;
class GetServiceUserCase {
    constructor(repo) {
        this.repo = repo;
        this.repo = repo;
    }
    execute(name, userId, page) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.repo.getServices(name, userId, page);
            return result;
        });
    }
}
exports.GetServiceUserCase = GetServiceUserCase;
