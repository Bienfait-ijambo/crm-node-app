...
function writeTypedefsToProduction() {
    ...
    const filePath = `${rootPath}/build/schema/typedefs.txt`;
...
const build = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield cleanTypeDefsFile(path.join(__dirname) + "/typedefs.txt");
    //write to development folder
    yield writeTypeDefsFile(path.join(__dirname) + "/typedefs.txt");
    //write to production folder
    yield writeTypedefsToProduction();
});
build();
